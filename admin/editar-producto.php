    ...
    <div class="row">
        ...
        <div class="col-md-8 col-sm-12">
            ...
            <div class="card card-primary">
                ...
                <!-- form start -->
                <form role="form" id="editar-producto" method="POST" action="procesos/procesar-producto.php"
                    enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="producto">Nombre Producto</label>
                            <input name="producto" type="text" class="form-control" placeholder="Producto" required
                                value="<?php echo $res_pro['producto'] ;?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="descripcion" rows="5" class="form-control" placeholder="Descripcion"
                                required> <?php echo $res_pro['descripcion_prod'] ;?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="precio" type="number" class="form-control" min="0" step="0.01"
                                ...
                                value="<?php echo $res_pro['precio_venta'] ;?>">
                        </div>

                        <div class="form-group">
                            <label for="garantia">Tiempo de garantia</label>
                            <input name="garantia" type="text" class="form-control" min="0"
                                placeholder="Por ejemplo: 2 años" required value="<?php echo $res_pro['garantia'] ;?>">
                        </div>
                        ...
                        while ($row_marca=$res_marca->fetch_assoc()) { ?>
                                        ...
                                        <option value="<?php echo $row_marca['id_marca']; ?>"
                                            <?php echo $res_pro['id_marca'] == ($row_marca['id_marca']) ? 'selected' : '' ;?>>
                        ...
                        while ($row_categoria=$res_categoria->fetch_assoc()) { ?>
                                        ...
                                        <option value="<?php echo $row_categoria['id_categoria']; ?>"
                                            <?php echo $res_pro['id_categoria'] == ($row_categoria['id_categoria']) ? 'selected' : '' ;?>>
                        ...
                        <div class="form-group">
                            ...
                            <img src="../img/productos/<?php echo  $res_pro['imagen1']!='' ? $res_pro['imagen1'] : 'sin-imagen.jpg'  ;?>"
                                width="150" alt=" no hay imagen">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <img src="../img/productos/<?php echo  $res_pro['imagen2']!='' ? $res_pro['imagen2'] : 'sin-imagen.jpg'  ;?>"
                                    width="150" alt=" no hay imagen">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <img src="../img/productos/<?php echo  $res_pro['imagen3']!='' ? $res_pro['imagen3'] : 'sin-imagen.jpg'  ;?>"
                                width="150" alt=" no hay imagen">
                        </div>
