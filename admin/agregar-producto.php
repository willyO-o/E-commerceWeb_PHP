    ...
    <div class="row">
        ...
        <div class="col-md-8 col-sm-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form role="form" id="registrar-producto" method="POST" action="procesos/procesar-producto.php" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="descripcion"   rows="5" class="form-control" placeholder="Descripcion" required></textarea>
                  </div>

                  <div class="form-group">
                    <label for="caracteristicas">Caracteristicas</label>
                    <textarea name="caracteristicas"   rows="10" class="form-control" placeholder="Caracteristicas" required></textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input name="stock_minimo" type="number" class="form-control"  min="0" placeholder="Stock minimo" required>
                  </div>

                  <div class="form-group">
                    <label for="precio">Precio de Venta <small>(solo numero) $us.</small></label>
                    <input name="precio" type="number" class="form-control"  min="0" step="0.01"placeholder="por ejemplo 100.50" required>
                  </div>

                  <div class="form-group">
                    <label for="garantia">Tiempo de garantia</label>
                    <input name="garantia" type="text" class="form-control"  min="0" placeholder="Por ejemplo: 2 años" required>
                  </div>
                    ...
                    <select name="categoria" id="" class="form-control">
                      ...
                      <?php
                        while ($row_categoria=$res_categoria->fetch_assoc()) { ?>
                          ...
                          <option value="<?php echo $row_categoria['id_categoria']; ?>"><?php echo $row_categoria['categoria'] ;?></option>
